            ...
            {orderId && status ? (
                <div class="reject-quote-from-mail">
                    <div class="reject-content">
                        ...
                        <p>
                            <label> {__( 'Please feel free to enter here your reason or provide us your feedback:', 'woocommerce-catalog-enquiry-pro' )}</label>
                            <textarea name="reason" id="reason" cols="10" rows="3" value={reason} onChange={(e) => setReason(e.target.value)}></textarea>
                        </p>
                            <button onClick={handleRejectQuote}>{__( 'Reject the quote', 'woocommerce-catalog-enquiry-pro' )}</button>
                    </div>
                </div>
            ) : ( orderId && (
                <div>
